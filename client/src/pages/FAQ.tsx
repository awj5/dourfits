...
function FAQ() {
  ...
  return (
    <div className="section" id="sectionFAQ">
      ...
      <p>200XP is automatically issued for each Dour Darcels or colette x Dour Darcels NFT you hold and 100XP for Dour Fits NFTs. Extra XP can be gained by participating in events. If you acquire additional Darcel NFTs in your wallet your XP will automatically update.</p>
      <h3>How do I get more items for my wardrobe?</h3>
      <p>Items in your wardrobe represent the traits of your Darcel NFTs. Additional item NFTs can be won in events or purchased on OpenSea while some items are available only when you have enough XP to unlock them.</p>
