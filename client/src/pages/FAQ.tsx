...
function FAQ() {
  ...
  return (
    <div className="section" id="sectionFAQ">
      ...
      <p>Yes you must own at least one NFT from the <a href="https://opensea.io/collection/dourdarcels" target="_blank" rel="noreferrer">Dour Darcels</a>, <a href="https://opensea.io/collection/dourfits" target="_blank" rel="noreferrer">Dour Fits</a> or <a href="https://opensea.io/collection/colettexdourdarcels" target="_blank" rel="noreferrer">colette x Dour Darcels</a> collections.</p>
      <h3>How do I gain more XP?</h3>
      <p>200XP is automatically issued for each Dour Darcels or colette x Dour Darcels NFT you hold and 100XP for Dour Fits NFTs. Extra XP can be gained via participating in and winning events. If you acquire additional Darcel NFTs your XP will automatically update.</p>
